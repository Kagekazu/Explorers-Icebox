...
internal static class Task_IslandInteract
{
    ...
    internal static unsafe bool? QueueNavmesh2(List<Vector3> List, bool mount, bool fly)
    {
        ...
        if (PlayerHelper.GetDistanceToPlayer(List[count]) < 0.5) // on the off chance that you're RIGHT there... there's no need to move to it
        {
            return true;
        }
